...
namespace DZ
{
    ...
    public static class ElectronicBookExtensions
    {
        public static double Average(this ElectronicBook book)
        {
            if (book == null)
            {
        ...
        public static float TakeHighest(this ElectronicBook book)
        {
            if (book == null)
            {
                throw new NullReferenceException();
        ...
        public static float TakeLowest(this ElectronicBook book)
        {
            if (book == null)
            {
                throw new NullReferenceException();
    ...
    public static class AdditionFunctionalityUsingLINQ
    {
        public static double Average(ElectronicBook book)
        {
            return AdditionFunctionalityUsingLINQ.Average(book);
        }

        public static float TakeHighest(ElectronicBook book)
        {
            return AdditionFunctionalityUsingLINQ.TakeHighest(book);
        }
        public static float TakeLowest(ElectronicBook book)
        {
            return AdditionFunctionalityUsingLINQ.TakeLowest(book);
        }
    }
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(book.TakeHighest());
            Console.WriteLine(book.TakeLowest());
        }
    }
}
